  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div className="max-w-3xl space-y-8 relative z-10 py-20">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-indigo-600 drop-shadow-lg">
          ...
          {sent ? (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={handleAuth}
                disabled={loading}
                className="bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-indigo-500 transition-all disabled:opacity-50 shadow-lg shadow-indigo-600/10 hover:shadow-indigo-600/20 active:scale-95 cursor-pointer"
              >
